...
export function InvoiceTemplate({ data }: Props) {
  ...
  return (
    <div className="bg-white shadow-2xl rounded-sm border border-slate-200 flex flex-col p-12 relative overflow-hidden print-area w-[210mm] max-w-[210mm] min-h-[297mm] !shadow-none !border-none !rounded-none" id="document-preview">
      <div 
      ...
      <div className="mt-auto border-t border-slate-200 pt-6 flex justify-between items-end">
        <div className="flex flex-col justify-end max-w-sm text-[10px] text-slate-400 italic">
          ...
          {data.company.signatureUrl && (
            <div className="mt-8 flex flex-col items-start w-64">
